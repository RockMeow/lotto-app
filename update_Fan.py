...
# Lottolyzer 加州天天樂 的歷史頁面網址
URL = "https://lottolyzer.com/history/united-states/fantasy-5-california"
...
def fetch_latest_draw():
    print("🔄 正在連線至 lottolyzer.com 抓取最新加州天天樂開獎資料...")
...
def update_csv(latest_data):
    csv_filename = 'Fan_history_all_sorted.csv'
